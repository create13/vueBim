...
//			o.index++;
	...
	this.readStart = function(data){
	    ...
	    camera = new THREE.PerspectiveCamera(45, jQuery(window).width() / jQuery(window).height(), o.far / 1000, o.far );
	    camera.position.x = o.center[0];
		camera.position.y = o.center[1];
		camera.position.z = o.center[2]+ o.diagonal;
